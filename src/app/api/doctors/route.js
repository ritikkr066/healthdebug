...
export async function POST(request){
    const{name,speciality,experiance,qualification,hospital,address,doctorid,phone}= await request.json()

    const doctor=new Doctors({
        name,speciality,experiance,qualification,hospital,address,doctorid,phone
    })
    try {
